...
// 返    回: 成功返回MI_OK
/////////////////////////////////////////////////////////////////////
MFRC522::StatusCode MFRC522::SelectTag(const uint8_t *pSnr)
{
    ...
    // 把CRC值和卡号发的卡里
    status = CommunicateWithTag(PCD_Command::TRANSCEIVE, ucComMF522Buf, 9, ucComMF522Buf, &unLen);

    if ((status == StatusCode::MI_OK) && (unLen == 0x18)) // 返回24个字节&状态为无错误
    {
